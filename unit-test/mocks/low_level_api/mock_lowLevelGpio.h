...
public:
   ...
   MOCK_METHOD2(openD_ll_gpio_readButton ,  openD_ll_gpio_buttonState_t( openD_ll_gpio_button_ctxt_t *buttonCtxt, openD_ll_gpio_pin_t pin, openD_ll_gpio_button_debounce_t debounce ));
