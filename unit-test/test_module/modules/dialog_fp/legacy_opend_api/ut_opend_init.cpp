 ...
 * Class definition
 */
class ut_dialog_legacy_fp_openD_init: public testing::Test
{
    public:
        // Mock objects
 ...
 */
TEST_F( ut_dialog_legacy_fp_openD_init, openD_init )
{
    EXPECT_EQ( OPEND_STATUS_ARGUMENT_INVALID, openD_init( NULL ) );
}
