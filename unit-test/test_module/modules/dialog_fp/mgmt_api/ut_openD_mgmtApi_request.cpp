 ...
 * Class definition
 */
class ut_dialog_fp_openD_mgmtApi_request: public testing::Test
{
    public:
 ...
 */
TEST_F( ut_dialog_fp_openD_mgmtApi_request, ut_openD_mgmtApi_request )
{
    EXPECT_EQ( OPEND_STATUS_ARGUMENT_INVALID, openD_mgmtApi_request(NULL) );
}
