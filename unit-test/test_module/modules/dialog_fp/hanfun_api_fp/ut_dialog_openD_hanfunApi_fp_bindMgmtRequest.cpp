 ...
 * @endcode
 *
 * @file       ut_dialog_openD_hanfunApi_fp_bindMgmtRequest.cpp
 ...
 * Class definition
 */
class ut_dialog_openD_hanfunApi_fp_bindMgmtRequest: public testing::Test
{
    public:
 ...
 * \details
 */
TEST_F( ut_dialog_openD_hanfunApi_fp_bindMgmtRequest, ut_dialog_openD_hanfunApi_fp_bindMgmtRequest_invalid_Pointer )
{
