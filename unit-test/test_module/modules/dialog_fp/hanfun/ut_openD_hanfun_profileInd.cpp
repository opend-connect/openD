 ...
 * @endcode
 *
 * @file       ut_opend_hanfun_profileind.cpp
 ...
 * Class definition
 */
class ut_openD_hanfun_profileInd: public testing::Test
{
    public:
 ...
 * */
/*!
 * \brief Tests the function openD_hanfun_profileInd.
 *
 * \details Verifies if the function works as expected when do not
 *          an initialization.
 */
TEST_F( ut_openD_hanfun_profileInd, ut_openD_hanfun_profileInd_NULL_Pointer )
{
  openD_hanfunApi_profileInd_t hProfileInd;

  EXPECT_EQ( OPEND_STATUS_FAIL, openD_hanfun_profileInd(&hProfileInd) );
}
 ...
 *          an initialization.
 */
TEST_F( ut_openD_hanfun_profileInd, ut_openD_hanfun_profileInd_valid_Pointer )
{
  ...
  EXPECT_EQ( OPEND_STATUS_OK, openD_hanfun_profileInd(&hProfileInd) );
}
