 ...
 * Class definition
 */
class ut_dspg_pp_openD_mgmtApi_request: public testing::Test
{
    public:
 ...
 */
TEST_F( ut_dspg_pp_openD_mgmtApi_request, ut_openD_mgmtApi_request )
{
    EXPECT_EQ( OPEND_STATUS_SERVICE_UNKNOWN, openD_mgmtApi_request(NULL) );
}
