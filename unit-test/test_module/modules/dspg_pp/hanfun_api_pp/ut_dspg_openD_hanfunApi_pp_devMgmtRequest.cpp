 ...
 * @endcode
 *
 * @file       ut_dspg_opend_hanfunapi_pp_devMgmtRequest.cpp
 ...
 * Class definition
 */
class ut_dspg_opend_hanfunapi_pp_devMgmtRequest: public testing::Test
{
    public:
        // Mock objects
        MockIwu ObjMockIwu;
 ...
 */
TEST_F( ut_dspg_opend_hanfunapi_pp_devMgmtRequest, ut_dspg_opend_hanfunapi_pp_devMgmtRequest_Null_Pointer )
{
