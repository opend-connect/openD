 ...
 * Class definition
 */
class ut_dspg_legacy_pp_openD_init: public testing::Test
{
    public:
        // Mock objects
        MockLowLevel ObjLowLevel;
        MockTransport ObjMockTransport;

        void SetUp()
        {
            setMockLowLevelReference(&ObjLowLevel);
            setMockTransportReference(&ObjMockTransport);
        }
        void TearDown()
        {
        }
 ...
 */
TEST_F( ut_dspg_legacy_pp_openD_init, openD_init )
{
