 ...
 * @endcode
 *
 * @file       ut_dspg_openD_hanfunApi_fp_profileRequest.cpp
 ...
 * Class definition
 */
class ut_dspg_openD_hanfunApi_fp_profileRequest: public testing::Test
{
    public:
 ...
 * \details
 */
TEST_F( ut_dspg_openD_hanfunApi_fp_profileRequest, ut_dspg_openD_hanfunApi_fp_profileRequest_invalid_Pointer )
{
