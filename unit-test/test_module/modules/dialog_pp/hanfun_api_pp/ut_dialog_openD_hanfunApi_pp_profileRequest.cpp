 ...
 * @endcode
 *
 * @file       ut_dialog_openD_hanfunApi_pp_profileRequest.cpp
 ...
 * Class definition
 */
class ut_dialog_openD_hanfunApi_pp_profileRequest: public testing::Test
{
    public:
        // Mock objects
        MockIwu ObjMockIwu;
 ...
 */
TEST_F( ut_dialog_openD_hanfunApi_pp_profileRequest, ut_dialog_openD_hanfunApi_pp_profileRequest_Null_Pointer )
{
