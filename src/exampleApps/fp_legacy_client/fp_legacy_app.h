 ...
 * @endcode
 *
 * @file       fp_legacy_app.h
 * @copyright  STACKFORCE GmbH, Heitersheim, Germany, www.stackforce.de
 * @author     Heiko Berger
 * @brief      fp legacy app api.
 * @details
 *
 ...
 *
 * @defgroup   legacy app api
 *             This file specifies the fp legacy app api with udp.
 * @{
 */
...
class Command
{
   ...
   * @brief   Key command.
   *
   * @details Getter for member variable usageCommand.
   *
   * @retval  Key of command.
   */
   ...
   * @details Getter for member variable usageCommand.
   *
   * @param   format Default false.
   *
   * @retval  usage of command.
   */
