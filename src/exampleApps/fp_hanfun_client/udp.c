 ...
 * @author     Heiko Berger
 * @brief      UDP client module implementation.
 * @details
 *
...
void udpSendHello()
{
  const char *buffer = "{\"module\":\"hanfun\",\"param1\":\"0\",\"param2\":\"0\",\"param3\":\"0\",\"primitive\":\"request\",\"service\":\"sendHello\",\"status\":\"OK\",\"version\":\"1.0.0\"}";
  /* Send with Ansi \0. */
